...
import 'package:flutter_jingdong/services/SearchServices.dart';
...
class _ProductListPageState extends State<ProductListPage> {
  ...
  _getProductListData() async {
    ...
    if (result.length < _pageSize) {
      setState(() {
        _productListData.addAll(result);
        _hasMore = false;
      });
    } else {
      setState(() {
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return Column(
              children: [
                GestureDetector(
                  onTap: () {
                    // print(_productListData[index]);
                    // 路由跳转
                    Navigator.pushNamed(context, '/productContent', arguments: {
                      'id': _productListData[index]['_id'],
                      'imageUrl': pic
                    });
                  },
                  child: Row(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text("¥${_productListData[index]['price']}",
            ...
            child: Row(
              ...
              return Expanded(
                child: InkWell(
                  ...
                  child: Padding(
                    padding: EdgeInsets.fromLTRB(0, ScreenAdapter.width(20), 0,
